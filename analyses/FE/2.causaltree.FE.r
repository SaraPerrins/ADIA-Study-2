...
dat$y <- dat$future_op_pos 
summary(dat$y)
dat <- dat[!is.na(dat$y), ] #n=825
#===============================================================================
...
#1 0.03832      0     1.000   1.00 0.0481
#2 0.02377      1     0.962   1.01 0.0492
#3 0.01851      3     0.914   1.01 0.0493
#4 0.01496      4     0.896   1.01 0.0499
#5 0.01436      6     0.866   1.01 0.0498
#6 0.01325      7     0.851   1.01 0.0498
#7 0.00564      8     0.838   1.03 0.0513
#8 0.00000      9     0.832   1.03 0.0508

#tree$cptable[, 1][which.min(tree$cptable[, 4])]=0.0383

opcp <- tree$cptable[, 1][which.min(tree$cptable[, 4])]
opcp <- 1.03+1*0.05 #nosplit, fix opcp to 0.01, get 3 nodes
