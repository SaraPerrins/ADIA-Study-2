...
tree <- with(df0, rpart(as.numeric(y) ~ . ,
...
#1  0.046114      0     1.000  1.009 0.0808
#2  0.006039      1     0.954  0.983 0.0819
#3  0.000663      3     0.942  1.041 0.0872
#4 -1.000000      5     0.940  1.041 0.0872
...
opcp <- tree$cptable[, "CP"][which.min(tree$cptable[, "xerror"])] #2 0.00604
#opcp <- 1.041 + 1*0.0872
...
prp(ptree, type = 4, # left and right split labels (see Figure 2)
    ...
    main = "Depression classical tree", # main title
