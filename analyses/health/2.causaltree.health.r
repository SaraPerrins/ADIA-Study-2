...
#1 0.03473      0     1.000  1.000 0.0546
#2 0.00466      1     0.965  0.991 0.0540
#3 0.00402      2     0.961  0.987 0.0537
#4 0.00085      3     0.957  0.987 0.0536
#5 0.00000      4     0.956  0.986 0.0536

opcp <- tree$cptable[, 1][which.min(tree$cptable[, 4])]
#opcp <- 0.986+1*0.0536 #alternative splitting
