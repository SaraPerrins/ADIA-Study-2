...
table(dat$RB_deliq_hi, useNA='ifany') #0=502 1=228 na=241
...
x.n <- c("center", "childrace_bsl", "cohort"
         , "childsex_bsl", "income", "numberhousehold")
...
x <- c("center", "childrace_bsl", "cohort"
       , "childsex_bsl", "income", "numberhousehold")#take out cohort from pair-matching, still in mom bal
