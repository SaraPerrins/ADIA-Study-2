...
out <- "RB_sexb"
dat$y <- dat$RB_sexb #0=854 1=50 na=450
table(dat$y, useNA = "ifany")
dat <- dat[!is.na(dat$y), ] #n=904
#===============================================================================
...
#Ye-no split, fix opcp to 0.000
# tree$cptable
#CP nsplit rel error xerror  xstd
#1 0.01306      0     1.000   1.00 0.271
#2 0.00411      2     0.974   1.02 0.274
#3 0.00123      3     0.970   1.02 0.274
#4 0.00000      4     0.969   1.02 0.274
...
prp(ptree_causal, type = 4, # left and right split labels (see Figure 2)
    ...
    main = "Risk sexual behavior causal tree", # main title
