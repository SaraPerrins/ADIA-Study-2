...
dat$y <- dat$anysud
#dat$y <- dat$YMDSYMP
#dat$y <- dat$YMDY #0=577 1=16 NA=378
...
lplot
png('output/anyMH.love.plot.png', width = 480*4,heigh=480*4,res=300)
lplot
dev.off()
...
saveRDS(sdat, file='data/anyMH.m.Rds')
...
#===============================================================================
sdat <- readRDS(sdat, file='data/anyMH.m.Rds')
...
png("output/anymh.classical.tree.plot.f.png", width = 480 * 4, heigh = 480 * 4, res = 300)
rpart.plot(ptree, roundint = FALSE)
dev.off()
