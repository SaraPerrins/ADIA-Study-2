...
#CP nsplit rel error xerror   xstd
#1  0.13415      0     1.000  1.159 0.0771
#2  0.10976      1     0.866  1.085 0.0778
#3  0.06098      2     0.756  0.951 0.0780
#4  0.02439      3     0.695  0.927 0.0779
#5  0.01220      4     0.671  0.902 0.0777
#6  0.00407      5     0.659  0.902 0.0777
#7  0.00000      8     0.646  0.902 0.0777
#8 -1.00000     10     0.646  0.902 0.0777

#opcp <- 0.01 # stop at #5CP
...
png(paste0("output/", out, ".tree.plot.classical.png")
...
prp(ptree, type = 4, # left and right split labels (see Figure 2)
    ...
    main = "Preganacy classical tree", # main title
